...
boss_job_specifics:
  ...
  RPR:
    timing:
      - '2m with strength, 1 lust and 1 gemdraught (7.21)'
    notes:
      - 'Pre-position boss on 1st Grey bomb, kill with lust'
      - 'Stun 2nd Grey bomb just before it finishes casting Burst'
      - 'Pre-position boss on 1st Giddy bomb - Hypothermal Combustion will interrupt both the boss and the 2nd Grey bomb, boss can be killed before Burst from 2nd Grey bomb'
---
