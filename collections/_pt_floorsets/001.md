...
boss_abilities:
  ...
  - name: Attack (shrublet add's auto-attacks)
    potency: 33
    type: Physical
...
boss_job_specifics:
  MCH:
    timing:
      - "4m45s at level 95 with strength (7.38)"
      - "4m at level 97 with strength (7.38)"
      - "2m at level 99 with strength and barkbalm (7.35)"
  WHM:
    notes:
