  ...
  - note: "Initial actions:"
    subnotes:
      - note: "Liturgy of Light (5 rings)"
        subnotes:
          - "The rings descend from above, each causing a Brutal Halo AoE when
            they land"
      ...
      - note: "Liturgy of Light (spinning circles)"
        subnotes:
          - "Generates a pair of spinning circle zones (either far + middle or
            ...
            arena. Standing in one triggers Bounds of Indulgence once per
            second"
      - "Grip of Salvation"
      - "Salvation's Reach"
      - "Grip of Salvation"
...
boss_job_specifics:
  MCH:
    timing:
      - "4m30s with strength (7.38)"
      - "2m45s with strength, haste, and barkbalm (7.35)"
  WHM:
    notes:
