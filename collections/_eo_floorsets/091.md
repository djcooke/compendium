...
boss_notes:
  ...
  - note: "Rotation after opening (1m20s per cycle):"
    subnotes:
...
The final boss is on floor 99. Floor 100 is just a long run to the finish.
Make sure you have time for this as it takes exactly 1m with a sprint on
entering the floor (thus 1m15s from touching the floor 99 key).
