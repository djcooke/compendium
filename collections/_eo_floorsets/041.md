...
boss_notes:
  ...
  - "Tanks can survive Ram's + Dragon's Voice combo with steel. DPS and healers
  may die to deep freeze DoT or a following auto-attack"
  - "Charge tether is potency 2700 when too close, which will one-shot
  DPS/healers through steel"
  - "If you are solo, your Cacaphony orb will always spawn west of center"
...
boss_job_specifics:
  ...
  SGE:
    timing:
      - "6m45s with no offensive pomanders (7.3)"
      - "4m with Unei (7.3)"
      - "2m50 with Doga (7.3)"
  SMN:
    timing:
